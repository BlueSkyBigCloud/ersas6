...
class IsAuthenticated(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        # Validate the token using TokenAuthentication
        try:
            user, auth_token = TokenAuthentication().authenticate_credentials(token)
        except AuthenticationFailed:
            return False  # Invalid token

        # If token is valid, the user will be returned
        request.user = user
        return True
